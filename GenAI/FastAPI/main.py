...
class Patient(BaseModel):
    ...
    city : Annotated[str, Field(..., description = "city of patient", examples=["New York"])]
    ...
    height : Annotated[float, Field(..., description = "height of patient in meters", gt = 0)]
    weight : Annotated[float, Field(..., description = "weight of patient in kgs", gt = 0)]
