...
# Environment config
SECRET_KEY = os.getenv("SECRET_KEY", "38e3e4a42b10a48b9415c8ebbe6871a2e38c928424823abf60e1d0f507b5a191")
...
require_operator = RoleChecker(["admin", "operator"]) # Both can operate the machine
